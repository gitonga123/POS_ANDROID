...
import com.example.eatitapplication.Model.Category;
import com.example.eatitapplication.Model.User;
import com.example.eatitapplication.ViewHolder.MenuViewHolder;
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        //Get Category Id and send it to the foodList Activity
